...
public class UdpClient {
	...
	public UdpClient(String server, int serverPort) throws Exception {
		...
		/*mSocket = new DatagramSocket(9999, InetAddress.getByName("127.0.0.1"));*/
	...
	public boolean sendData(final byte[] data) throws IOException {
		...
		System.out.printf("[Udp Client] [%s:%d] Send msg to %s:%d <%s>, cnt %d\n",
	...
	public byte[] recvData(boolean block) throws IOException {
		...
		System.out.printf("[Udp Client] [%s:%d] Get msg from %s:%d <%s>, cnt %d\n", 

...
public class ScDeviceList extends Activity implements OnClickListener {
	   ...
	   public void onCreate(Bundle savedInstanceState) {
			...
			listItemAdapter = new SimpleAdapter(this, listItem, R.layout.dl_list_items ,
			new String[]{"image","type","name"},  new int[]{R.id.dl_item_image,R.id.dl_item_type,R.id.dl_item_name});
	   ...
	   private void onCreateDeviceInfoLoad(){
		...
		private void setViewClickListeners() {
			...
			device_lv.setOnItemClickListener(new OnItemClickListener() {  
	            ...
	            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,  long arg3) { 
	        	   ...
	        	   //String tvbox_str= getResources().getString(R.string.tv_box_str);
	            	
	            	if(type.getText().equals(tv_str))
	            	{
	            		/*
	            		Intent it = new Intent(ScDeviceList.this,TvCtrlActivity.class);
	            	...
	            	{
	            		//startActivity(new Intent(ScDeviceList.this, AirCtrlActivity.class));
	            	}
	            	else
	            	{
			...
			/*device_lv.setOnCreateContextMenuListener(new OnCreateContextMenuListener() {    
			    public void onCreateContextMenu(ContextMenu menu, View v,ContextMenuInfo menuInfo) {
			    	 String str_ok = getString(R.string.sure);
			    	 String str_del = getString(R.string.doudelete);
			        menu.setHeaderTitle(str_del);
			        menu.add(0, 0, 0, str_ok);
			        //menu.add(0, 1, 0, str_cancel);    
			    }
			});*/
			device_lv.setOnItemLongClickListener(new OnItemLongClickListener() {   
				public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
	                //get item name
					  TextView  tv_name = (TextView) view.findViewById(R.id.dl_item_name);
	                ...
	                // change content
	                TextView tv_title = (TextView) mDialog.getWindow().findViewById(R.id.dl_dialog_title);
	                tv_title.setText(str_name);
	                
	                // set on dialog click
	                final int idx = position;
	                Button btn = (Button) mDialog.getWindow().findViewById(R.id.dl_dialog_del_dev_btn);
		...
		public void onClick(View v) {
			...
			{
				// if net config is done before, then i think no need to consider wifi status here
				startDeviceAddAct();
			}
		}		
